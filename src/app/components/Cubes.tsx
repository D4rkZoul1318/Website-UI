...
const Cubes = ({
  ...
  const colGap = typeof cellGap === 'number' ? `${cellGap}px` : (cellGap as CellGapObject)?.col !== undefined ? `${(cellGap as CellGapObject).col}px` : '5%';
  const rowGap = typeof cellGap === 'number' ? `${cellGap}px` : (cellGap as CellGapObject)?.row !== undefined ? `${(cellGap as CellGapObject).row}px` : '5%';
