...
export function ChillSection() {
  ...
  return (
    <section id="chill" ref={ref} className="flex items-center justify-center" style={{ minHeight: "100vh", backgroundColor: "#F2F0EB" }}>
      <div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "80px", padding: "0 24px", flexWrap: "wrap" }}>
        ...
        <div style={{ maxWidth: "520px" }}>
          ...
          <p style={{ ...fadeUp(200), fontFamily: "'Outfit', sans-serif", fontWeight: 300, fontSize: "clamp(16px, 2vw, 22px)", color: "#6B6B6B", lineHeight: 1.6, margin: "0 0 32px" }}>
